...
{
    /// <inheritdoc />
    public partial class AddColorAndIconColumns : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAdmins", x => new { x.UserId, x.ManagerId });
                    table.ForeignKey(
                        name: "FK_UserAdmins_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserAdmins_Users_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionBudgetImpactId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TransactionId = table.Column<int>(type: "int", nullable: false),
                    BudgetId = table.Column<int>(type: "int", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionBudgetImpacts", x => x.TransactionBudgetImpactId);
                    table.ForeignKey(
